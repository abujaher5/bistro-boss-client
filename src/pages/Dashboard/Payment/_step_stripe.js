...
install stripe on the server side and get client secret.make sure that used the payment method types:['card']
6.from client side get the client get the client secret and save it.
